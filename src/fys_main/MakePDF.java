    ...
    public static void createPDF(String date, String time, String airport
        ...
        try {
            ...
            com.itextpdf.text.Image image = 
                    com.itextpdf.text.Image.getInstance("src/logo.jpg");
            image.scalePercent(20);
            image.setAlignment(Element.ALIGN_CENTER);

            //Create Paragraph
            Paragraph title = new Paragraph("Lost Bagage Registration Form"
            ...
            cell = new PdfPCell(new Phrase("Traveller Information:", 
            ...
            //create title and add to table
            cell = new PdfPCell(new Phrase("Bagage Lable Information:", 
                    new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLDITALIC)));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setColspan(2);
            ...
            //create title and add to table
            cell = new PdfPCell(new Phrase("Baggage Information:", 
                    new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLDITALIC)));
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setColspan(2);
            ...
            //create cells and add values
            cell = new PdfPCell(new Phrase("Signature traveller:", 
                    new Font(Font.FontFamily.TIMES_ROMAN, 12, Font.BOLDITALIC)));
            cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
            cell.setFixedHeight(40f);
            signatureTable.addCell(cell).setBorder(0);
            signatureTable.addCell("");

            cell = new PdfPCell(new Phrase("Signature customer service:", 
                    new Font(Font.FontFamily.TIMES_ROMAN, 12, Font.BOLDITALIC)));
            cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
            signatureTable.addCell(cell).setBorder(0);
            signatureTable.addCell("");
