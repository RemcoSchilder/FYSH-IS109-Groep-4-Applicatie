 ...
 * @author freek
 */
public class HS_SearchUsers {
    
    private static TableView<SearchUsers> table = new TableView<>();
    private static ObservableList<SearchUsers> data = FXCollections.observableArrayList();
    
    public static TableView<SearchUsers> searchUsers() {
    ...
    public static class SearchUsers {
        ...
        private SearchUsers(String name, String username, String password, String email, String function) {
